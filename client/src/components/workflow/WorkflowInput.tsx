      ...
      <div className="p-4 sm:p-6 lg:p-8 border-b border-border bg-gradient-to-br from-background via-background to-muted/20">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <div className="flex items-center justify-center mb-3">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary to-primary/90 bg-clip-text text-transparent">
              Cue A<span className="bg-gradient-to-r from-primary to-primary bg-clip-text">I</span>
            </h1>
          </div>
