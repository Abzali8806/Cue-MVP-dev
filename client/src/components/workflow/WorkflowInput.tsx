        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <div className="space-y-3">
            ...
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-muted-foreground">
              Effortless workflow automation from prompt to deployment with <span className="font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Cue</span>
            </h2>
          </div>
